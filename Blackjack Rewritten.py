...
class Blackjack(object):
    ...
    def __init__(self):
        ...
        self.winner_file = PhotoImage(file=self.graphic_path+'win.gif')
        self.loser_file = PhotoImage(file = self.graphic_path+'lose.gif')
        #Key bindings
    ...
    def addImage(self):
        ...
        self.filename[self.cards] = PhotoImage(file = self.graphic_path+self.images[self.cards])
    ...
    def addDealerImage(self):
        ...
        self.dfilename[self.dcards] = PhotoImage(file=self.graphic_path+self.dimages[self.dcards])
